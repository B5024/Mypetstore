...
public class MailcodeServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (session.getAttribute("mailFrom").equals("findPassword")) {
            response.sendRedirect("findPasswordForm");
        }else if (session.getAttribute("mailFrom").equals("register")) {
            response.sendRedirect("registerForm");
        }else if (session.getAttribute("mailFrom").equals("changeMail")) {
